...
function countWeekdays($year, $month) {
    ...
    for ($d = 1; $d <= $days; $d++) {
        if (date('N', mktime(0,0,0,$month,$d,$year)) < 6) $count++;
    }
    return $count;
}
...
<head>
    <meta charset="UTF-8">
    <title>Monthly Attendance – SDHOD | Security Attendance and Billing Portal</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .forward-section-header { display:flex; align-items:center; justify-content:space-between; margin-bottom:1.25rem; flex-wrap:wrap; gap:0.75rem; }
        .forward-section-title { font-size:1rem; font-weight:700; color:#1f2937; display:flex; align-items:center; gap:0.5rem; }
        .forward-section-title i { color:var(--role); }
        ...
        .form-control:focus { border-color:var(--role); box-shadow:0 0 0 3px rgba(220,38,38,0.1); }
        ...
        .btn-approve-final { background:linear-gradient(135deg,#dc2626,#b91c1c); color:white; padding:0.85rem 2.5rem; font-size:1rem; font-weight:700; letter-spacing:0.3px; }
        .btn-approve-final:hover { background:linear-gradient(135deg,#b91c1c,#991b1b); transform:translateY(-1px); box-shadow:0 6px 18px rgba(220,38,38,0.35); }
        .btn-approve-final i { font-size:1.1rem; }
        ...
        .success-banner { width:100%; background:linear-gradient(135deg,#dc2626 0%,#b91c1c 60%,#991b1b 100%); border-radius:18px; padding:3.5rem 2rem; display:flex; flex-direction:column; align-items:center; gap:1.25rem; box-shadow:0 8px 32px rgba(220,38,38,0.3); }
        ...
        .success-check i { font-size:2rem; color:#dc2626; }
        ...
        .success-card-title i { color:#dc2626; }
        ...
        .success-steps { display:flex; align-items:center; justify-content:center; gap:0.4rem; margin-top:0.75rem; flex-wrap:wrap; }
        .success-step-chip { font-size:0.72rem; font-weight:700; padding:0.25rem 0.7rem; border-radius:20px; background:#d1fae5; color:#059669; border:1px solid #86efac; }
        .success-step-chip.final { background:#fee2e2; color:#b91c1c; border-color:#fca5a5; }
        ...
        .page-btn:hover { border-color:var(--role); color:var(--role); }
        .page-btn.active { background:var(--role); color:white; border-color:var(--role); }
            ...
            <div class="success-banner">
                ...
                <div class="success-card">
                    ...
                    <div class="success-steps">
                        ...
                        <span class="success-step-chip">GM ✓</span>
