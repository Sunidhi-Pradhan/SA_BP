...
<div class="dashboard-layout">
    <aside class="sidebar">
        ...
        <ul class="sidebar-nav">
            ...
            <li><a href="sdhod_monthly.php" class="nav-link"><i class="fa-solid fa-calendar-days"></i><span>Monthly Attendance</span></a></li>
            ...
            <div class="profile-card">
                ...
                <div class="profile-header">
                    ...
                    <div class="profile-header-info">
                        ...
                        <span class="role-chip"><i class="fa-solid fa-user-tie"></i> <?= htmlspecialchars($user['role']) ?></span>
                    </div>
                </div>
                ...
                <div class="info-grid">
                    ...
                    <div class="info-box">
                        ...
                        <?php else: ?>
                            <div class="info-value muted">All Sites (SDHOD)</div>
                        <?php endif; ?>
                    </div>
                ...
                <!-- Back button -->
                <div class="clearfix">
                    <a href="monthlyatt.php" class="btn-back">
