...
// ── Fetch APM user details & site code ──
...
// ── Active staff count (APM's site only) ──
...
<title>Security Attendance and Billing Portal – APM Dashboard</title>
...
.role-badge {
  ...
  background: var(--role-light); color: #92400e;
...
<div class="layout">
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <ul class="sidebar-nav">
      ...
      <li>
        <a class="nav-link" href="monthly_attendance.php">
  ...
  <main class="main-content">
    ...
    <div>
      ...
      <div class="page-heading">
        ...
        <div class="filters">
          <!-- Site badge (no dropdown – APM sees only their site) -->
