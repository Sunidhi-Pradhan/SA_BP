...
$alreadyApproved = ($currentStep !== 'APM');
...
if (isset($_POST['approve_report']) && !$alreadyApproved) {
    ...
    if ($workflowRow) {
        ...
        $workflowJson = json_encode([
            ...
            "current_step_id" => 3,
            "steps" => [
                ["id"=>1,"Code"=>"ASO",  "status"=>"approved","comment"=>"auto","acted_by"=>null,"acted_at"=>$actedAt,"auto_approved"=>true],
                ["id"=>2,"Code"=>"APM",  "status"=>"approved","comment"=>$comment,"acted_by"=>$approvedById,"acted_at"=>$actedAt,"auto_approved"=>false],
                ["id"=>3,"Code"=>"GM",   "status"=>"pending","comment"=>null,"acted_by"=>null,"acted_at"=>null,"auto_approved"=>false],
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .header-icon {
            ...
            color: #6b7280; font-size: 1rem; border: 1px solid #e5e7eb;
        ...
        .attendance-stat-card:nth-child(1) { animation-delay: 0.45s; }
        .attendance-stat-card:nth-child(2) { animation-delay: 0.55s; }
        .attendance-stat-card:nth-child(3) { animation-delay: 0.65s; }
        ...
        .attendance-table-wrapper {
            ...
            border: 1px solid #e5e7eb; -webkit-overflow-scrolling: touch;
            scrollbar-width: thin; scrollbar-color: #0f766e #f0f0f0;
        }
        ...
        .attendance-table tbody tr:nth-child(1)  { animation-delay: 0.80s; }
        .attendance-table tbody tr:nth-child(2)  { animation-delay: 0.87s; }
        .attendance-table tbody tr:nth-child(3)  { animation-delay: 0.94s; }
        .attendance-table tbody tr:nth-child(4)  { animation-delay: 1.01s; }
        .attendance-table tbody tr:nth-child(5)  { animation-delay: 1.08s; }
        .attendance-table tbody tr:nth-child(6)  { animation-delay: 1.15s; }
        .attendance-table tbody tr:nth-child(7)  { animation-delay: 1.22s; }
        .attendance-table tbody tr:nth-child(8)  { animation-delay: 1.29s; }
        .attendance-table tbody tr:nth-child(9)  { animation-delay: 1.36s; }
        .attendance-table tbody tr:nth-child(10) { animation-delay: 1.43s; }
        .attendance-table tbody tr:nth-child(n+11) { animation-delay: 1.48s; }
        ...
        .pagination {
            ...
            opacity: 0;
            animation: fadeUp 0.4s 1.15s ease forwards;
        }
        .page-btn {
        ...
        .success-banner::before {
            content:''; position:absolute; inset:0;
            background:radial-gradient(ellipse at 30% 50%,rgba(255,255,255,0.12) 0%,transparent 60%),radial-gradient(ellipse at 80% 20%,rgba(255,255,255,0.08) 0%,transparent 50%);
            pointer-events:none;
        }
        .success-check {
        ...
        .success-card-title i { color:#6b7280; font-size:0.95rem; }
        ...
        <div id="attendanceContent" <?= $approvalSuccess ? 'style="display:none"' : '' ?>>
            ...
            <div class="card">
                ...
                <div class="legend">
                    ...
                    <div class="legend-item"><div class="legend-box status-pp">PP</div><span>Overtime</span></div>
                    ...
                    <form method="POST" id="approvalForm">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="comment" id="commentBox" rows="5"
                                placeholder="Add your APM approval comment..." required></textarea>
                        </div>
                        <div class="forward-btn-group">
                            <button type="submit" name="approve_report" class="btn btn-primary">
                                <i class="fa-solid fa-check"></i> APPROVE & FORWARD TO GM
                            </button>
                        </div>
                    </form>
                </div>
            ...
            <div class="success-banner">
                ...
                <div class="success-card">
                    <div class="success-card-title">
                        ...
                        APM APPROVED & FORWARDED TO GM
                    </div>
                    <div class="success-card-desc">
                        You have successfully reviewed and forwarded this attendance report to GM for the next stage of approval.
                    </div>
