...
// GM is step 3 — check if GM has already acted
if ($workflow) {
...
if (isset($_POST['approve_report']) && !$alreadyApproved) {
    ...
    if ($workflowRow) {
        /* UPDATE existing row — mark GM approved, advance to HQSO */
        $pdo->prepare("
        ...
        /* INSERT full workflow row with GM approved (fallback — ASO/APM skipped) */
        ...
        $workflowJson = json_encode([
            ...
            "steps" => [
                ...
                ["id"=>2,"Code"=>"APM",  "status"=>"approved","comment"=>null,
                 "acted_by"=>null,"acted_at"=>null,"auto_approved"=>true],
                ["id"=>3,"Code"=>"GM",   "status"=>"approved","comment"=>$comment,
            ...
            <div class="workflow-section">
                ...
                <div class="workflow-meta">
                    ...
                    Last Approved By: <strong>
                        <?php
                            // Find the last approved step before the current one
                            $lastApprovedCode = '—';
                            if ($workflow) {
            ...
            <div class="success-banner">
                ...
                <div class="success-card">
                    ...
                    <div class="success-card-desc">
                        You have successfully reviewed and forwarded this attendance report to HQSO for the next stage of approval.
                    </div>
